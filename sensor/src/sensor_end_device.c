...
/**
 * @brief   Inicializa el ADC para muestrear tensión y corriente en los canales
 *          analógicos A2 y A3 correspondientemente. Utiliza referencia interna
 *          de 2.5V y tiempo de sample-and-hold de 64 ciclos de ADC10CLK.
 */
void initAdc(void)
{
    ...
    // espera que se estabilice la referencia (tarda aprox. 30us)
    delayMs(1);
...
void harmonics(void)
{
    ...
    // etapa no recursiva. calculo de potencia y thd de cada armónico con
